	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<div class="cart gray4012">
				<a href="/dangdang/cart/cartlist.action">购物车</a>
			</div>
		</div>
		...
		<s:if test="#session.user==null">
			[&nbsp;<a href="../user/login_form.jsp" class="b">登录</a>|<a href="../user/register_form.jsp" class="b">注册</a>&nbsp;]
		</s:if>
		<s:else>[&nbsp;<a href="/dangdang/user/exit.action" class="b" id="exit">登出</a>&nbsp;]</s:else>
